...
let handler = async (m, { conn, usedPrefix, DevMode }) => { 
    try { 
        ...
        if (global.DATABASE._data.users[m.sender].healt > 79) {
            ...
            let rubah = global.DATABASE._data.users[m.sender].harimau
            ...
            let str = ` 
Nyawa mu berkurang -${healt * 1} karena Kamu telah berpetualang sampai Goa ${pickRandom(['Jepang', 'Korea', 'Bali', 'Amerika', 'Israel', 'German', 'Finlandia', 'Ke bawa dunia mimpi', 'Ujung dunia', 'Mars', 'Bulan', 'Pluto', 'Matahari', 'Hatinya dia', '...'])} dan mendapatkan
*💠exp:* ${exp} 
*💸uang:* ${uang}
